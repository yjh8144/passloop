export const ja: Record<string, string> = {
  ...
  autoNext: "自動次へ",
  autoNextPause: "結果を表示",
  autoNextScopeLabel: "不正解時",
  autoNextScopeAll: "次へ進む",
  autoNextScopeCorrect: "不正解は留まる",
  sort: "並べ替え",
  manual: "元の順序",
  random: "ランダム",
  name: "名前順",
  ...
  remoteBackupTitle: "リモートバックアップと復元",
  remoteBackupDesc:
    "現在の設定をバックアップサーバーへアップロード、または既存バックアップから復元します。復元時はマージか上書きを選択します。",
  remoteServerUrl: "サーバーURL",
  remoteUsername: "ユーザー名",
  remotePassword: "パスワード",
  remoteBackupNote: "バックアップメモ",
  remoteBackupNotePlaceholder: "例：端末変更前",
  remoteUploadCurrent: "現在の設定をアップロード",
  remoteUploading: "アップロード中...",
  remoteRefreshList: "バックアップ一覧を更新",
  remoteLoadingList: "読み込み中...",
  remoteBackupList: "バックアップ一覧",
  remoteBackupTotal: "合計 {0} 件",
  remoteBackupListEmptyHint:
    "サーバーURL、ユーザー名、パスワードを入力して一覧を更新、または現在の設定をアップロードしてください。",
  remoteBackupNoItems: "リモートバックアップはまだありません。",
  remoteBackupUntitled: "無題のバックアップ",
  remoteRestoreBackup: "このバックアップを復元",
  remoteBackupPage: "{0} / {1} ページ",
  remoteBackupSecurityNote:
    "保存されるのはサーバーURLとユーザー名のみです。パスワードは保存しません。公開サーバーではHTTPSを使用してください。",
  remoteCredentialsRequired: "サーバーURL、ユーザー名、パスワードを入力してください。",
  remoteBackupUploaded: "現在の設定をリモートにバックアップしました。",
  remoteBackupRegistered: "ユーザーを自動登録し、バックアップを完了しました。",
  invalidRemoteServerUrl: "サーバーURLが無効です。http:// または https:// を使用してください。",
  remoteUsernameRequired: "ユーザー名を入力してください。",
  remotePasswordRequired: "パスワードを入力してください。",
  ...
  // Export confirm
  confirmExportBackup:
    "エクスポートされる設定ファイルには、リスト、問題、解答記録、アプリ設定が含まれます。LLMプロバイダー設定、APIキー、プロキシキーは含まれません。プライバシーを保護し、信頼できない相手にファイルを共有しないでください。エクスポートしますか？",
