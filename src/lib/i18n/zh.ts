export const zh: Record<string, string> = {
  ...
  welcomeHeader: "欢迎使用 PassLoop",
  welcomeIntro: "PassLoop 是一个纯前端的刷题系统，所有数据保存在浏览器缓存中。以下是快速上手指南：",
  onboardingStep1Title: "选择或新建题单",
  onboardingStep1Desc: "左侧边栏的「题单」列表可切换不同题单，点击 + 按钮可新建题单。",
  onboardingStep2Title: "导入题目",
  onboardingStep2Desc: "点击左侧「导入题目」上传 JSON 文件，或在「题库管理」页面手动添加题目。",
  onboardingStep3Title: "LLM 解析",
  onboardingStep3Desc: "粘贴未整理的题目文本，配置 LLM 后一键转换为标准题库格式。",
  onboardingStep4Title: "刷题练习",
  onboardingStep4Desc: "在「刷题台」中答题，系统会记录正确率、用时和错题。右上角有设置按钮，可切换排序、模式等选项。",
  onboardingStep5Title: "错题重练",
  onboardingStep5Desc: "点击「错题临时页」可集中练习做错的题目。",
  onboardingTipText: "提示：数据存储在浏览器本地，清除浏览器缓存会丢失数据。建议定期使用「导出配置」备份。",
  ...
  resetToDefaultProxy: "重置为默认代理",
  resetToDefaultKey: "重置为默认密钥",
