export const zh: Record<string, string> = {
  ...
  autoNext: "答后自动下一题",
  autoNextPause: "停留看结果",
  autoNextScopeLabel: "错题处理",
  autoNextScopeAll: "都跳转",
  autoNextScopeCorrect: "错题停留",
  sort: "排序",
  manual: "原顺序",
  random: "随机",
  name: "按名称",
  ...
  obPractice5: "错题操作可在未完成时使用；若仍有未做题，会先询问是否将未做题也算作错题。",
  ...
  remoteBackup: "远程备份",
  remoteBackupTitle: "远程备份与恢复",
  remoteBackupDesc:
    "将当前配置上传到你的数据保存端，或从已有备份恢复。恢复前会先让你选择合并或覆盖。",
  remoteServerUrl: "服务端地址",
  remoteUsername: "用户名",
  remotePassword: "密码",
  remoteBackupNote: "备份备注",
  remoteBackupNotePlaceholder: "例如：换电脑前、期末复习版本",
  remoteUploadCurrent: "上传当前配置",
  remoteUploading: "上传中...",
  remoteRefreshList: "刷新备份列表",
  remoteLoadingList: "加载中...",
  remoteBackupList: "备份列表",
  remoteBackupTotal: "共 {0} 条",
  remoteBackupListEmptyHint: "填写服务端地址、用户名和密码后，刷新列表或上传当前配置。",
  remoteBackupNoItems: "还没有远程备份。",
  ...
  invalidRemoteServerUrl: "服务端地址无效，请填写 http:// 或 https:// 地址。",
  remoteUsernameRequired: "请填写用户名。",
  remotePasswordRequired: "请填写密码。",
