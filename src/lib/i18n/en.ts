export const en: Record<string, string> = {
  ...
  welcomeHeader: "Welcome to PassLoop",
  welcomeIntro: "PassLoop is a frontend-only quiz system. All data is stored in your browser. Here's a quick start guide:",
  onboardingStep1Title: "Select or create a list",
  onboardingStep1Desc: "Switch between lists in the sidebar, click + to create a new one.",
  onboardingStep2Title: "Import questions",
  onboardingStep2Desc: "Click \"Import Questions\" to upload JSON, or add manually in Question Bank.",
  onboardingStep3Title: "LLM Parser",
  onboardingStep3Desc: "Paste unformatted text and convert to standard format with LLM.",
  onboardingStep4Title: "Practice",
  onboardingStep4Desc: "Answer questions in Practice mode. The system records accuracy, time, and wrong answers. Settings are in the top-right corner.",
  onboardingStep5Title: "Wrong set review",
  onboardingStep5Desc: "Click \"Wrong Set\" to practice questions you got wrong.",
  onboardingTipText: "Tip: Data is stored locally. Clearing browser cache will lose data. Export config regularly as backup.",
  ...
  resetToDefaultProxy: "Reset to default proxy",
  resetToDefaultKey: "Reset to default key",
