export const ko: Record<string, string> = {
  ...
  welcomeHeader: "PassLoop에 오신 것을 환영합니다",
  welcomeIntro: "PassLoop은 프론트엔드 전용 문제 연습 시스템입니다. 모든 데이터는 브라우저에 저장됩니다. 빠른 시작 가이드:",
  onboardingStep1Title: "목록 선택/생성",
  onboardingStep1Desc: "사이드바에서 목록 전환, + 버튼으로 새로 생성.",
  onboardingStep2Title: "문제 가져오기",
  onboardingStep2Desc: "\"문제 가져오기\"로 JSON 업로드 또는 문제 관리에서 수동 추가.",
  onboardingStep3Title: "LLM 분석",
  onboardingStep3Desc: "정리되지 않은 텍스트를 붙여넣고 LLM으로 표준 형식 변환.",
  onboardingStep4Title: "연습",
  onboardingStep4Desc: "연습 모드에서 답하기. 정답률/시간/오답 기록. 우측 상단에 설정 버튼.",
  onboardingStep5Title: "오답 복습",
  onboardingStep5Desc: "\"오답 세트\"에서 틀린 문제를 집중 연습.",
  onboardingTipText: "팁: 데이터는 로컬 저장됩니다. 브라우저 캐시 삭제 시 데이터 손실. 정기적으로 설정 내보내기로 백업하세요.",
  ...
  resetToDefaultProxy: "기본 프록시로 재설정",
  resetToDefaultKey: "기본 키로 재설정",
