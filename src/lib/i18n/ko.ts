export const ko: Record<string, string> = {
  ...
  remoteBackup: "원격 백업",
  remoteBackupTitle: "원격 백업 및 복원",
  remoteBackupDesc:
    "현재 설정을 백업 서버에 업로드하거나 기존 백업에서 복원합니다. 복원 시 병합 또는 덮어쓰기를 선택합니다.",
  remoteServerUrl: "서버 URL",
  remoteUsername: "사용자 이름",
  remotePassword: "비밀번호",
  remoteBackupNote: "백업 메모",
  remoteBackupNotePlaceholder: "예: 기기 변경 전",
  remoteUploadCurrent: "현재 설정 업로드",
  remoteUploading: "업로드 중...",
  remoteRefreshList: "백업 목록 새로고침",
  remoteLoadingList: "불러오는 중...",
  remoteBackupList: "백업 목록",
  remoteBackupTotal: "총 {0}개",
  remoteBackupListEmptyHint:
    "서버 URL, 사용자 이름, 비밀번호를 입력한 뒤 목록을 새로고침하거나 현재 설정을 업로드하세요.",
  remoteBackupNoItems: "아직 원격 백업이 없습니다.",
  remoteBackupUntitled: "제목 없는 백업",
  remoteRestoreBackup: "이 백업 복원",
  remoteBackupPage: "{0} / {1} 페이지",
  remoteBackupSecurityNote:
    "서버 URL과 사용자 이름만 저장됩니다. 비밀번호는 저장하지 않습니다. 공개 서버에서는 HTTPS를 사용하세요.",
  remoteCredentialsRequired: "서버 URL, 사용자 이름, 비밀번호를 먼저 입력하세요.",
  remoteBackupUploaded: "현재 설정이 원격 백업에 업로드되었습니다.",
  remoteBackupRegistered: "사용자가 자동 등록되고 백업이 업로드되었습니다.",
  invalidRemoteServerUrl: "서버 URL이 잘못되었습니다. http:// 또는 https:// 주소를 사용하세요.",
  remoteUsernameRequired: "사용자 이름을 입력하세요.",
  remotePasswordRequired: "비밀번호를 입력하세요.",
  ...
  // Export confirm
  confirmExportBackup:
    "내보내기 파일에는 목록, 문제, 답변 기록, 앱 설정이 포함됩니다. LLM 제공자 구성, API 키, 프록시 키는 포함되지 않습니다. 개인정보를 보호하고 신뢰할 수 없는 사람에게 파일을 공유하지 마세요. 내보내시겠습니까?",
